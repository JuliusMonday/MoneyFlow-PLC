...
const transfer = async (req, res) => {
    ...
    try {
        ...
        res.json({ fromAccount:`The total amount of ${amount} was transferred from ${fromAccount.lastName} ${fromAccount.firstName} to ${toAccount.lastName} ${toAccount.firstName}.$ Total balance:::${fromAccount.balance}.00`, toAccount });
    } catch (error) {
