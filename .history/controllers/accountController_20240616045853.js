...
const transfer = async (req, res) => {
    ...
    try {
        ...
        res.json({ fromAccount:`The total amount of ${amount} was transferred from ${fromAccount.lastName} ${fromAccount.} to ${toAccount.lastName} ${toAccount.firstName}`, toAccount });
    } catch (error) {
